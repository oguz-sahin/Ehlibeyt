...
import com.example.firstapplication.adapter.DiniGunAdapter
...
class dini_days_activity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var rv = findViewById<RecyclerView>(R.id.dini_days_recyclerview)

        rv.layoutManager = LinearLayoutManager(this)

        rv.adapter = DiniGunAdapter(this, dini_days_array, this)
    ...
    override fun ondDiniDaysClick(Dinidays: DiniGunModel) {
        ...
        var intent = Intent(this, dini_days_detay_avtivity::class.java)

        var ozel_gun = intent.putExtra("diniGün", "${Dinidays.ozel_gun} texti")
